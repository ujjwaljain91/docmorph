      ...
      <div className="pt-24 pb-12 px-6">
        <div className="max-w-5xl mx-auto">
          <ToolHeader
            ...
            description="Extract tables and data from PDF files into Excel spreadsheets. Perfect for data analysis, reporting, and spreadsheet calculations."
              ...
              <Card className="p-8 shadow-elegant hover:shadow-glow transition-all duration-300 border-2 border-transparent hover:border-primary/20">
                <div className="text-center">
                  <div className="flex justify-center mb-6">
                    <div className="p-6 bg-gradient-to-br from-green-500 to-green-600 rounded-2xl shadow-glow">
                  ...
                  <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                    Your PDF will be analyzed to extract tables and data into an Excel spreadsheet (.xlsx) 
          ...
          {result && (
            <div className="mb-8">
              <CompletionStatus
                ...
                onReset={handleReset}
                downloadText="Download Excel Spreadsheet"
              />
            </div>
          )}
