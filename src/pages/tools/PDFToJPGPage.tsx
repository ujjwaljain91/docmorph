      ...
      <div className="pt-24 pb-12 px-6">
        <div className="max-w-5xl mx-auto">
          <ToolHeader
            ...
            description="Convert PDF pages into high-quality JPG images. Perfect for sharing, viewing, or using PDF content as images."
            badgeText="🖼️ PDF to JPG"
            onBack={() => navigate('/')}
          />
              ...
              <Card className="p-8 shadow-elegant hover:shadow-glow transition-all duration-300 border-2 border-transparent hover:border-primary/20">
                <div className="text-center">
                  <div className="flex justify-center mb-6">
                    <div className="p-6 bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl shadow-glow">
                  ...
                  <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                    Your PDF pages will be converted to high-quality JPG images 
                    perfect for viewing, sharing, or web use.
                  </p>
                  <Button 
          ...
          {result && (
            <div className="mb-8">
              <CompletionStatus
                ...
                onReset={handleReset}
                downloadText="Download JPG Images"
              />
            </div>
          )}
